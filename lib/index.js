    ...
    return {
      send: options => {
        return new Promise(async(resolve, reject) => {
          ...
          transporterConfig = {
            ...transporterConfig,
            secure: options.secure ? options.secure === true : Number.parseInt(config.port) === 465,
            secureConnection: options.secure ? options.secure === true : Number.parseInt(config.port) === 465,
            pool: !!options.pool,
